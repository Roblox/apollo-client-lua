...
-- ROBLOX comment: https://github.com/thisdot/graphql-tag-lua/blob/main/src/luaUtils/Map.lua
...
function Map.new(iterable)
	...
	if iterable ~= nil then
		...
		if iterableType == "table" then
			arrayFromIterable = Array.from(iterable, nil)
		else
...
local function coerceToMap(mapLike: Map<any, any> | Table<any, any>)
