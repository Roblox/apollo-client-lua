-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/react/hooks/__tests__/useLazyQuery.test.tsx
			...
			return Promise.resolve()
				:andThen(function()
					...
					local function Component()
						...
						if condition == 0 then
							jestExpect(loading).toEqual(false)
							setTimeout(function()
								execute()
							end)
						elseif condition == 1 then
							jestExpect(loading).toEqual(true)
