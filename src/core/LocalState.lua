-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/core/LocalState.ts
...
local apolloClientModule = require(script.Parent.ApolloClient)
