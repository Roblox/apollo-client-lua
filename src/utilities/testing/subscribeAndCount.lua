-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/utilities/testing/subscribeAndCount.ts
...
local typesModule = require(script.Parent.Parent.Parent.core.types)
type ApolloQueryResult<T> = typesModule.ApolloQueryResult<T>
type OperationVariables = typesModule.OperationVariables
local observableModule = require(script.Parent.Parent.Parent.utilities.observables.Observable)
type ObservableSubscription = observableModule.ObservableSubscription
local asyncMap = require(script.Parent.Parent.Parent.utilities.observables.asyncMap).asyncMap
