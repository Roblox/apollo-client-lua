-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/utilities/testing/mocking/mockSubscriptionLink.ts
...
local utilitiesModule = require(script.Parent.Parent.Parent.Parent.utilities)
local Observable = utilitiesModule.Observable
type Observable<T> = utilitiesModule.Observable<T>
local coreModule = require(script.Parent.Parent.Parent.Parent.link.core)
