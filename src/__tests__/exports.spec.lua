-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/__tests__/exports.ts
...
return function()
	...
	describe("exports of public entry points", function()
		...
		local function check(id: string, ns: Namespace, missingExports: Array<string>?)
			...
			it(id, function()
				table.insert(testedIds, id)
				jestExpect(Array.sort(Array.concat(Object.keys(ns :: Object), missingExports or {}))).toMatchSnapshot()
			end)
		end
		...
		it("completeness", function()
			...
			entryPoints.forEach(function(info: Record<string, any>)
				...
				jestExpect(testedIds).toContain(id)
			end)
		end)
	end)
end
