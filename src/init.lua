-- ROBLOX upstream: https://github.com/apollographql/apollo-client/blob/v3.4.0-rc.17/src/index.ts
local exports = {}
...
export type Cache_DiffOptions<TVariables, TData> = coreModule.Cache_DiffOptions<TVariables, TData>
